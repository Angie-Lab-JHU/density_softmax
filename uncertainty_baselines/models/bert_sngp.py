...
class SpectralNormalizedFeedforwardLayer(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    Args:
      ...
      intermediate_activation: Activation function to be used for the intermediate
        layer.
      intermediate_size (to-be-removed): Same as intermediate_size.
      intermediate_activation (to-be-removed): Same as intermediate_activation.
