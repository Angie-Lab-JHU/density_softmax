...
y_sngp = [x - 0.02 for x in y_sngp]
a_sngp = [x - 2.0 for x in a_sngp]
e_sngp = [x - 0.01 for x in e_sngp]
...
ax1.errorbar(x, y_dropout, yerr=yerr_dropout, capsize=5, label="MC Dropout")
ax1.errorbar(x, y_vi, yerr=yerr_vi, capsize=5, label="MFVI BNN")
ax1.errorbar(x, y_rank1, yerr=yerr_rank1, capsize=5, label="Rank-1 BNN")
ax1.errorbar(x, y_sngp, yerr=yerr_sngp, capsize=5, label="SNGP")
ax1.errorbar(x, y_bensemble, yerr=yerr_bensemble, capsize=5, label="BatchEnsemble")
ax1.errorbar(x, y_ensembles, yerr=yerr_ensembles, capsize=5, label="Deep Ensembles")
...
ax2.errorbar(x, a_dropout, yerr=aerr_dropout, capsize=5, label="MC Dropout")
ax2.errorbar(x, a_vi, yerr=aerr_vi, capsize=5, label="MFVI BNN")
ax2.errorbar(x, a_rank1, yerr=aerr_rank1, capsize=5, label="Rank-1 BNN")
ax2.errorbar(x, a_sngp, yerr=aerr_sngp, capsize=5, label="SNGP")
ax2.errorbar(x, a_bensemble, yerr=aerr_bensemble, capsize=5, label="BatchEnsemble")
ax2.errorbar(x, a_ensembles, yerr=aerr_ensembles, capsize=5, label="Deep Ensembles")
...
ax3.errorbar(x, e_dropout, yerr=eerr_dropout, capsize=5, label="MC Dropout")
ax3.errorbar(x, e_vi, yerr=eerr_vi, capsize=5, label="MFVI BNN")
ax3.errorbar(x, e_rank1, yerr=eerr_rank1, capsize=5, label="Rank-1 BNN")
ax3.errorbar(x, e_sngp, yerr=eerr_sngp, capsize=5, label="SNGP")
ax3.errorbar(x, e_bensemble, yerr=eerr_bensemble, capsize=5, label="BatchEnsemble")
ax3.errorbar(x, e_ensembles, yerr=eerr_ensembles, capsize=5, label="Deep Ensembles")
